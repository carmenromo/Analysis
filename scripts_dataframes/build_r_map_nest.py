...
"""
python buil_r_map_nest.py 0 1 2 /Users/carmenromoluque/Desktop/ full_body_center_nest_fixed /Users/carmenromoluque/Desktop/
"""
...
def load_sens_pos(file_name):
    sens_pos = pd.read_hdf(file_name, 'MC/sns_positions')
    return sens_pos
...
evt_file  = f"{data_path}/full_body_r_map_nest_{start}_{numb}_{threshold}"
...
for number in range(start, start+numb):
    ...
    for evt in events:
        ...
        select, true_pos = rf2.true_photoelect_new_nexus(evt_parts, evt_hits)
