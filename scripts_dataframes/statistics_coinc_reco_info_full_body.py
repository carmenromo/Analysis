...
$ python statistics_coinc_reco_info_full_body.py 22 1 2 4 4 2 /Users/carmenromoluque/Desktop/ full_body_iradius380mm_z200cm_depth3cm_pitch7mm /Users/carmenromoluque/Analysis/fastmc/r_table_full_body_195cm_thr2pes.h5 /Users/carmenromoluque/Desktop/
"""
...
evt_file  = f"{data_path}/full_body_statistics_coinc_reco_info_{start}_{numb}_{thr_r}_{thr_phi}_{thr_z}_{thr_e}"
...
for number in range(start, start+numb):
    ...
    for evt in events:
        ...
        pos1, pos2, q1, q2, true_pos1, true_pos2, true_t1, true_t2, sns1, sns2 = rf2.reconstruct_coincidences(evt_sns, charge_range, DataSiPM_idx, evt_parts, evt_hits)
...
np.savez(evt_file, a_true_r1=a_true_r1, a_true_phi1=a_true_phi1, a_true_z1=a_true_z1,
         ...
         a_true_time1=a_true_time1, a_true_time2=a_true_time2, a_event_ids=a_event_ids,
