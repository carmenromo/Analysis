...
python reconstruct_coincidences_fast_sim_only_phot.py 10000 1 /Users/carmenromoluque/nexus_petit_analysis/fastmc_reconst/ full_body_phantom_paper_true_reco_thr
...
for file_number in range(start, start+numb_of_files):
    ...
    file_name = folder_in + filename + f'0_25pes.{file_number}.h5'
    print(file_number)
    try:
