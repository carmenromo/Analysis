...
"""
python ctr_full_body_PET_no_dist_nest.py 0 1 2 4 4 2 /Users/carmenromoluque/Desktop/ full_body_center_nest_fixed /Users/carmenromoluque/Analysis/fastmc/r_table_full_body_195cm_thr2pes.h5 /Users/carmenromoluque/Desktop/
"""
...
evt_file  = f"{data_path}/full_body_nest_ctr_no_dist_tof_{start}_{numb}_{thr_r}_{thr_phi}_{thr_z}_{thr_e}"
...
for number in range(start, start+numb):
    ...
    for evt in events:
        ...
        min_id1, min_id2, min_t1, min_t2 = rf.find_first_times_of_coincidences(evt_sns, evt_tof, charge_range, DataSiPM_idx, evt_parts, evt_hits)
