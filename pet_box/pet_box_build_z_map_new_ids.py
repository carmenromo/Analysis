...
true_z_max_id_144 = [[] for i in range(thr_ch_start, thr_ch_nsteps)]
var_x_max_id_144  = [[] for i in range(thr_ch_start, thr_ch_nsteps)]
charge_max_id_144 = [[] for i in range(thr_ch_start, thr_ch_nsteps)]
evts_max_id_144   = [[] for i in range(thr_ch_start, thr_ch_nsteps)]

sensor_corner_tile5 = 144
area0 = [44, 45, 54, 55]

evt_file   = f'{out_path}/pet_box_build_z_map_new_ids_{start}_{numb}_{thr_ch_start}_{thr_ch_nsteps}'
        ...
        if phot and len(sel_neg_phot)>0: ### Be careful with the meaning of this condition
            ...
            for th in range(thr_ch_start, thr_ch_nsteps):
                ...
                if max_charge_s_id_tile5 == sensor_corner_tile5:
                    true_z_max_id_144[th].append(sel_neg_phot[0])
                    var_x_max_id_144 [th].append(var_xs)
                    charge_max_id_144[th].append(sum(qs_neg))
                    evts_max_id_144  [th].append(evt)
...
true_z_max_id_144_a = np.array([np.array(i) for i in true_z_max_id_144])
var_x_max_id_144_a  = np.array([np.array(i) for i in var_x_max_id_144])
charge_max_id_144_a = np.array([np.array(i) for i in charge_max_id_144])
evts_max_id_144_a   = np.array([np.array(i) for i in evts_max_id_144])
...
np.savez(evt_file, true_z_all_0=true_z_all_a[0], true_z_all_1=true_z_all_a[1], true_z_all_2=true_z_all_a[2],
                   ...
                   true_z_max_id_144_0=true_z_max_id_144_a[0], true_z_max_id_144_1=true_z_max_id_144_a[1], true_z_max_id_144_2=true_z_max_id_144_a[2],
                   true_z_max_id_144_3=true_z_max_id_144_a[3], true_z_max_id_144_4=true_z_max_id_144_a[4], true_z_max_id_144_5=true_z_max_id_144_a[5],
                   var_x_max_id_144_0=var_x_max_id_144_a[0], var_x_max_id_144_1=var_x_max_id_144_a[1], var_x_max_id_144_2=var_x_max_id_144_a[2],
                   var_x_max_id_144_3=var_x_max_id_144_a[3], var_x_max_id_144_4=var_x_max_id_144_a[4], var_x_max_id_144_5=var_x_max_id_144_a[5],
                   charge_max_id_144_0=charge_max_id_144_a[0], charge_max_id_144_1=charge_max_id_144_a[1], charge_max_id_144_2=charge_max_id_144_a[2],
                   charge_max_id_144_3=charge_max_id_144_a[3], charge_max_id_144_4=charge_max_id_144_a[4], charge_max_id_144_5=charge_max_id_144_a[5],
                   evts_max_id_144_0=evts_max_id_144_a[0], evts_max_id_144_1=evts_max_id_144_a[1], evts_max_id_144_2=evts_max_id_144_a[2],
                   evts_max_id_144_3=evts_max_id_144_a[3], evts_max_id_144_4=evts_max_id_144_a[4], evts_max_id_144_5=evts_max_id_144_a[5])
