...
evt_file   = f'{out_path}/pet_box_true_info_teflon_block_simple_both_phot_{start}_{numb}'
...
both_phot_a = np.array(both_phot)
...
np.savez(evt_file, both_phot=both_phot_a)
