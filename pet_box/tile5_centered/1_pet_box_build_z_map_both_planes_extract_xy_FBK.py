...
""" To run this script
python 1_pet_box_build_z_map_both_planes_extract_xy_FBK.py 0 1 0 6 /Users/carmenromoluque/nexus_petit_analysis/tof_setup/PetBox_analysis/data_h5/
...
evt_file   = f'{out_path}/pet_box_build_z_map_both_planes_FBK_{start}_{numb}_{thr_ch_start}_{thr_ch_nsteps}'
...
for number in range(start, start+numb):
    ...
    sns_positions_c = pbf.correct_FBK_sensor_pos(sns_positions, both_planes=True)
...
np.savez(evt_file, true_z1_all_0=true_z1_all_a[0], true_z1_all_1=true_z1_all_a[1], true_z1_all_2=true_z1_all_a[2],
        ...
        true_x1_all_0=true_x1_all_a[0], true_x1_all_1=true_x1_all_a[1], true_x1_all_2=true_x1_all_a[2],
        true_x1_all_3=true_x1_all_a[3], true_x1_all_4=true_x1_all_a[4], true_x1_all_5=true_x1_all_a[5],
        true_y1_all_0=true_y1_all_a[0], true_y1_all_1=true_y1_all_a[1], true_y1_all_2=true_y1_all_a[2],
        true_y1_all_3=true_y1_all_a[3], true_y1_all_4=true_y1_all_a[4], true_y1_all_5=true_y1_all_a[5],
        ...
        true_x1_0=true_x1_a[0], true_x1_1=true_x1_a[1], true_x1_2=true_x1_a[2],
        true_x1_3=true_x1_a[3], true_x1_4=true_x1_a[4], true_x1_5=true_x1_a[5],
        true_y1_0=true_y1_a[0], true_y1_1=true_y1_a[1], true_y1_2=true_y1_a[2],
        true_y1_3=true_y1_a[3], true_y1_4=true_y1_a[4], true_y1_5=true_y1_a[5],
        ...
        true_x2_all_0=true_x2_all_a[0], true_x2_all_1=true_x2_all_a[1], true_x2_all_2=true_x2_all_a[2],
        true_x2_all_3=true_x2_all_a[3], true_x2_all_4=true_x2_all_a[4], true_x2_all_5=true_x2_all_a[5],
        true_y2_all_0=true_y2_all_a[0], true_y2_all_1=true_y2_all_a[1], true_y2_all_2=true_y2_all_a[2],
        true_y2_all_3=true_y2_all_a[3], true_y2_all_4=true_y2_all_a[4], true_y2_all_5=true_y2_all_a[5],
        ...
        true_x2_0=true_x2_a[0], true_x2_1=true_x2_a[1], true_x2_2=true_x2_a[2],
        true_x2_3=true_x2_a[3], true_x2_4=true_x2_a[4], true_x2_5=true_x2_a[5],
        true_y2_0=true_y2_a[0], true_y2_1=true_y2_a[1], true_y2_2=true_y2_a[2],
        true_y2_3=true_y2_a[3], true_y2_4=true_y2_a[4], true_y2_5=true_y2_a[5],
