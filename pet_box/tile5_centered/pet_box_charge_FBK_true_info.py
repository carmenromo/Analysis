...
""" To run this script
python pet_box_charge_FBK_true_info.py 2500 1 0 5 /Users/carmenromoluque/nexus_petit_analysis/tof_setup/PetBox_analysis/data_h5 PetBox_asymmetric_HamamatsuVUV
...
evt_file   = f'{out_path}/pet_box_charge_FBK_true_info_{start}_{numb}_{thr_ch_start}_{thr_ch_nsteps}'
