...
""" To run this script
python 2_pet_box_reco_info_both_planes_test_z_map_c_plane.py 2500 1 /Users/carmenromoluque/nexus_petit_analysis/tof_setup/PetBox_analysis/data_h5/ PetBox_asymmetric_HamamatsuVUV
...
zpos_file2_path = arguments.zpos_file2
...
Zpos3 = load_map(zpos_file3, group="Zpos",
                             node=f"f2pes200bins",
                             x_name='Var_x',
                             y_name='Zpos',
                             u_name='ZposUncertainty')
...
np.savez(evt_file, reco_x1=reco_x1, reco_x2=reco_x2, reco_y1=reco_y1, reco_y2=reco_y2, reco_z1=reco_z1, reco_z2=reco_z2, reco_z3=reco_z3,
