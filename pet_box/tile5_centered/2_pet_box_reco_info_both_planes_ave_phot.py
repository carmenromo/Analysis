...
""" To run this script
python 2_pet_box_reco_info_both_planes_ave_phot.py 2500 1 /Users/carmenromoluque/nexus_petit_analysis/tof_setup/PetBox_analysis/data_h5/ PetBox_asymmetric_HamamatsuVUV
...
evt_file   = f'{out_path}/pet_box_reco_info_tile5_centered_evt_ids_ave_phot_{start}_{numb}'
                ...
                if count1 and count2: ## Coincidences
                    ...
                    for k, th in enumerate(timestamp_thr):
                        ...
                        for j, n_pe in enumerate(ave_phot):
                            try:
                                min_id1, min_id2, min_t1, min_t2 = rf.find_coincidence_timestamps(evt_tof_exp_dist, ids1, ids2, n_pe)
                            except:
