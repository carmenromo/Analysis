...
""" To run this script
python 2_pet_box_reco_info_both_planes_jitter_mix_Ham_FBK.py 2500 1 /Users/carmenromoluque/nexus_petit_analysis/tof_setup/PetBox_analysis/data_h5/ PetBox_asymmetric_HamamatsuVUV
...
evt_file   = f'{out_path}/pet_box_reco_info_tile5_centered_evt_ids_jitter_mix_Ham_FBK_no_cut_charge_{start}_{numb}'
