...
""" To run this script
python 2_pet_box_reco_info_both_planes_mix_Ham_FBK_analysis_as_data.py 0 1 /Users/carmenromoluque/nexus_petit_analysis/tof_setup/PetBox_analysis/data_h5/ PetBox_asymmetric_HamamatsuVUV
...
evt_file   = f'{out_path}/pet_box_reco_info_t5cent_mix_Ham_FBK_no_cut_charge_analysis_data_only_det_plane_{start}_{numb}'
...
for number in range(start, start+numb):
    ...
    for evt in events:
        ...
        if phot and len(sel_neg_phot)>0:
            ...
            if len(qs1)==0 or len(qs2)==0: ## Coincidences
                continue
...
np.savez(evt_file, reco_x1=reco_x1, reco_y1=reco_y1, reco_z1=reco_z1,
                   true_x1=true_x1, true_y1=true_y1, true_z1=true_z1,
                   sns_resp1=sns_resp1, event_ids1=event_ids1)
...
#                    event_ids_times=event_ids_times,
