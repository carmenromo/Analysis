...
err_r_phot_file      = table_folder + '/errmat_full_body_phantom_paper_r_phot_like.npz'
err_r_compt_file     = table_folder + '/errmat_full_body_phantom_paper_r_compt_like.npz'
err_phi_phot_file    = table_folder + '/errmat_full_body_phantom_paper_phi_phot_like.npz'
err_phi_compt_file   = table_folder + '/errmat_full_body_phantom_paper_phi_compt_like.npz'
err_z_phot_file      = table_folder + '/errmat_full_body_phantom_paper_z_phot_like.npz'
err_z_compt_file     = table_folder + '/errmat_full_body_phantom_paper_z_compt_like.npz'
err_t_th_phot_file0  = table_folder + '/errmat_full_body_phantom_paper_t_thr0pes_phot_like.npz'
err_t_th_compt_file0 = table_folder + '/errmat_full_body_phantom_paper_t_thr0pes_compt_like.npz'
err_t_th_phot_file1  = table_folder + '/errmat_full_body_phantom_paper_t_thr0.25pes_phot_like.npz'
err_t_th_compt_file1 = table_folder + '/errmat_full_body_phantom_paper_t_thr0.25pes_compt_like.npz'
err_t_th_phot_file2  = table_folder + '/errmat_full_body_phantom_paper_t_thr0.5pes_phot_like.npz'
err_t_th_compt_file2 = table_folder + '/errmat_full_body_phantom_paper_t_thr0.5pes_compt_like.npz'
err_t_th_phot_file3  = table_folder + '/errmat_full_body_phantom_paper_t_thr0.75pes_phot_like.npz'
err_t_th_compt_file3 = table_folder + '/errmat_full_body_phantom_paper_t_thr0.75pes_compt_like.npz'
...
for file_number in range(start, start+numb_of_files):
    ...
    for evt in events:
        ...
        evt_df0 = fmc.simulate_reco_event(evt, hits, particles, errmat_r_phot,
                                          ...
                                          errmat_phi_compt, errmat_z_compt, errmat_t_th_compt0, energy_threshold)
        ...
        evt_df1 = fmc.simulate_reco_event(evt, hits, particles, errmat_r_phot,
                                          ...
                                          errmat_phi_compt, errmat_z_compt, errmat_t_th_compt1, energy_threshold)
        ...
        evt_df2 = fmc.simulate_reco_event(evt, hits, particles, errmat_r_phot,
                                          ...
                                          errmat_phi_compt, errmat_z_compt, errmat_t_th_compt2, energy_threshold)
        ...
        evt_df3 = fmc.simulate_reco_event(evt, hits, particles, errmat_r_phot,
                                          ...
                                          errmat_phi_compt, errmat_z_compt, errmat_t_th_compt3, energy_threshold)
