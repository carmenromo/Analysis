...
#evt_file  = '/data4/NEXT/users/paolafer/dev_area/ic_dev/petalo/full_body/phantom/full_body_phantom_coincidences_all_charge_{0}_{1}_{2}_{3}_{4}_{5}'.format(start, numb, int(thr_r), int(thr_phi), int(thr_z), int(thr_e))
#rpos_file = '/data4/NEXT/users/paolafer/dev_area/ic_dev/petalo/tables/r_table_full_body_195cm_thr{}pes.h5'.format(int(thr_r))

### gpu1 ###
#folder = '/home/paolafer/sim/full_body_phantom_paper/'
folder = '/Users/carmenromoluque/nexus_petit_analysis/full-body-phantom-paper/'
file_full = folder + 'full_body_phantom_paper.{0}.h5'
#evt_file  = '/sim/full_body_phantom_paper/analysis/full_body_phantom_paper_coincidences_{0}_{1}_{2}_{3}_{4}_{5}'.format(start, numb,  int(thr_r), int(thr_phi), int(thr_z), int(thr_e))
evt_file = folder + f'full_body_phantom_paper_coincidences_{start}_{numb}_{int(thr_r)}_{int(thr_phi)}_{int(thr_z)}_{int(thr_e)}'
#rpos_file = '/home/paolafer/analysis/tables/r_table_full_body_phantom_paper_thr{0}pes.h5'.format(int(thr_r))
rpos_file = folder + f'r_table_full_body_phantom_paper_thr{int(thr_r)}pes.h5'
#rpos_file = '/Users/carmenromoluque/Analysis/full_body_pet/r_table_full_body_195cm_4cmdepth_thr2pes.h5'
